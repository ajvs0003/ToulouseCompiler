...
subroutine vec3 selectTypeIlumination(vec4 textColor);
...
subroutine(selectTypeIlumination)
vec3 diffuseAndSpecularPointLight(vec4 textColor){
...
subroutine(selectTypeIlumination)
vec3 diffuseAndSpecularDirectionalLight(vec4 textColor){
	vec3 kad = textColor.rgb;
...
subroutine(selectTypeIlumination)
vec3 diffuseAndSpecularSpotLight(vec4 textColor){
...
void main(){
	...
	fragColor = vec4(diffuseSpecularUniform(textColor),textColor.w);
